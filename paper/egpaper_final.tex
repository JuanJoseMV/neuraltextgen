...
some attention heads are going to focus on the verb "was", other attention heads are focused
on the special tokens "[CLS]" and "[SEP]" that represent the beginning and the end of the sentence
respectively, finally other attention heads will focus on the word "animal". In this way BERT can
...
%\begin{quote}
%   [POSITIVE] Nonostante l'odio sportivo verso la @juventusfc, che grande colpo portare @Cristiano in @SerieA\_TIM! Spero il @sscnapoli risponda a questo colpo!
%\end{quote}
%\begin{quote}
%   [NEGATIVE] #FranciaVsArgentina #FifaWorldCup2018 @mascherano è un giocatore che mi è sempre piaciuto ma che mi sembra ormai improponibile a questi livelli
%\end{quote}
[POSITIVE]:
\begin{quote}
